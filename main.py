...
def save_modle_result(test_result):
    ...
    path = f"./result/{args.type}/{args.data_type}_{args.model}_{args.model_dim}_{args.epochs}_{args.pca}.json"
...
if __name__ == '__main__':
    ...
    if args.data_type == 'vectortype':
        ...
        if args.pca == 'True':
            contracts_with_vulnerabilities, contracts_without_vulnerabilities = Split_dataset_graphvectortype_pca(vectors_file, labels_file, types_file)
        elif args.pca == 'add':
            contracts_with_vulnerabilities, contracts_without_vulnerabilities = Split_dataset_graphvectortype_pca_add(
                vectors_file, labels_file, types_file)
        else:
            contracts_with_vulnerabilities, contracts_without_vulnerabilities = Split_dataset_graphvectortype(vectors_file, labels_file,
                                                                                                          types_file)
    elif args.data_type == 'graph_vector':
            contracts_with_vulnerabilities, contracts_without_vulnerabilities = Split_dataset_graphvector(vectors_file, labels_file)

    elif args.data_type == 'graph_type':
            contracts_with_vulnerabilities, contracts_without_vulnerabilities = Split_dataset_graphtype(types_file, labels_file)
